...
public class UpdateStudent extends JFrame implements ActionListener {
    ...
    UpdateStudent(){
       ...
       submit=new JButton("Update");
        ...
        delete.setBounds(450, 500, 120, 30);
     ...
     public void actionPerformed(ActionEvent ae){
        ...
        String rollno = labelrollno.getText(); // Get the roll number to delete
        if (rollno.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Roll Number is empty", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                ...
                setVisible(false); // Optionally close the form
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
