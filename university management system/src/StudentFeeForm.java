...
public class StudentFeeForm  extends JFrame implements ActionListener{
    ...
    StudentFeeForm(){
     ...
     ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/icons/fee.jpg"));//toput the image on the frame
    ...
    add(lblrollnumber);
       ...
       String course[]={"BTech","BCA","BBA","Bsc","Msc","MCA","MBA","MCom","MA","BA"};
