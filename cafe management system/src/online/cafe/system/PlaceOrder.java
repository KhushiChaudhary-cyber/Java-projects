...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1890, 0, 30, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 143, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Name");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 239, -1, -1));
        ...
        getContentPane().add(txtCustName, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 266, 300, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Mobile Number");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 314, -1, -1));
        ...
        getContentPane().add(txtCustMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 349, 300, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Email");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 389, -1, -1));
        ...
        getContentPane().add(txtCustEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 424, 300, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Category");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(479, 113, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 145, 300, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Search");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 213, 64, -1));
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 237, 300, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 314, 300, 660));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Name");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(907, 113, -1, -1));
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(907, 145, 300, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setText("Price");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1504, 113, -1, -1));
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1504, 135, 300, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Quantity");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 210, -1, 20));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Total");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1504, 198, -1, -1));
        getContentPane().add(txtProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1504, 237, 300, -1));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(907, 247, 300, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(907, 314, -1, -1));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1667, 294, -1, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("--");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 115, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(917, 377, 907, 600));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel14.setText("Grand Total:Rs.");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 1010, -1, -1));

        lblGrandTotal.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblGrandTotal.setText("000");
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 1010, -1, -1));
        ...
        getContentPane().add(btnGenerateBillPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(1580, 990, -1, -1));

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/doughnut-dreams-soaring-high-in-creative-delight-generative-ai-free-photo.jpg"))); // NOI18N
    ...
    // Create and save the bill in DB
    Bill bill = new Bill();
    bill.setId(billId);
    ...
    // Path where bill will be stored
    String path = "D:\\bills\\";  // Change this if necessary
    String fileName = path + billId + ".txt";
    ...
    try {
        ...
        // Header
        writer.write("*********************************************\n");
        writer.write("                 LATTE WORLD                \n");
        writer.write("*********************************************\n\n");
        writer.write("Bill ID       : " + billId + "\n");
        writer.write("Date          : " + todayDate + "\n");
        writer.write("Customer Name : " + customerName + "\n");
        writer.write("Mobile Number : " + customerMobileNumber + "\n");
        writer.write("Email         : " + customerEmail + "\n\n");
        ...
        for (int i = 0; i < jTable2.getRowCount(); i++) {
            ...
            String prodPrice = jTable2.getValueAt(i, 1).toString();
            String prodQty = jTable2.getValueAt(i, 2).toString();
            String prodTotal = jTable2.getValueAt(i, 3).toString();

            writer.write(String.format("%-20s %-10s %-10s %-10s\n", prodName, prodPrice, prodQty, prodTotal));
        }

        writer.write("--------------------------------------------------\n");
        writer.write("Grand Total: Rs. " + grandTotal + "\n");
        writer.write("--------------------------------------------------\n");
        writer.write("Thank you! Please visit again.\n");

        writer.close();

        JOptionPane.showMessageDialog(null, "Bill generated at: " + fileName);
        Openpdf.OpenById(String.valueOf(billId)); // Open method can be updated to open .txt file
